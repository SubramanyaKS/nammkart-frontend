...
const CategorySidebar = () => {
  ...
  return (
    <div>
      ...
      <h2 className="p-4 text-center text-lg border-b font-bold mb-4">Categories</h2>
      <nav className="mt-4">
      <ul className="space-y-2">
        <li className="px-4 py-2 hover:bg-gray-200 cursor-pointer hover:text-blue-500">
        <a href="#" onClick={()=>handleSearch('')}>All</a>
      </li>
    {data.map((d,i)=>(
        <li key={i} className="px-4 py-2 hover:bg-gray-200 cursor-pointer hover:text-blue-500">
